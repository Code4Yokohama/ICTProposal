...
CIOの配下に専門職員を配し、市役所が関与するICTをはじめとするデジタル技術関連のプロジェクトを統括、支援する体制(Digital Technology Management Office:DTMO等)を整備、システムアーキテクチャやデータの設計、オープンソースの活用のされ方、知財管理のされ方までをガバナンスします。
