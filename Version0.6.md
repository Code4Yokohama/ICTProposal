...
従来、ICTスキルといえばWindows等OSや、Microsoft Office（ワード、エクセル、パワーポイント）といったOAツールを操作できる、といった程度のことを指していましたが、現在、行政の現場で求められるICTスキルはソーシャルメディアの活用から、データ分析、データマネジメント、セキュリティ対応、クラウド活用まで広範になってきています。さらには、これら、日々高度化する技術に対応しながら、ICT関連プロジェクトをマネージメントできる職員が求められています。
